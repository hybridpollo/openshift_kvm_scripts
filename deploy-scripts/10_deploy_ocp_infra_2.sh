...
# infra vm. Infra vms are worker nodes labeled post-installation
# to dedicate certain cluster-wide components to be hosted on the infra nodes
#
...
IGNITION_CONFIG="/lv_data/kvm_ocp/ocp_upi_installation_directory/worker.ign"
IMAGE="/var/lib/libvirt/images/ocp4-infra2.qcow2"
VM_NAME="infra2.arl-ocp4.lab.acanorex.io"
VCPUS="4"
RAM_MB="16384"
DISK_GB="200"
EXT_BRIDGE_NAME="br-lab_ext"
EXT_BRIDGE_MAC="00:16:3e:7d:30:45"
